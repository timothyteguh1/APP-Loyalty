    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(newStatus ? 'Banner diaktifkan' : 'Banner dinonaktifkan'),
  ...
  Future<void> _deleteBanner(Map<String, dynamic> banner) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Yakin ingin menghapus "${banner['title'] ?? 'Banner ini'}"?',
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  const SizedBox(width: 12),
                  Text(
                    existing == null ? 'Tambah Banner' : 'Edit Banner',
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                              ...
                              : () async {
                                  if (pickedBytes == null &&
                                    ...
                                    ScaffoldMessenger.of(ctx).showSnackBar(const SnackBar(
                                      content: Text('Gambar banner wajib dipilih'),
                                  ...
                                  try {
                                    ...
                                    if (pickedBytes != null && pickedFile != null) {
                                      ...
                                      await _admin.storage
                                          .from('upsol-assets')
                                          .uploadBinary(fileName, pickedBytes!);
                          ...
                          child: isSaving
                              ...
                              : Text(
                                  existing == null ? 'Tambah Banner' : 'Simpan',
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: Text('${_banners.length} banner',
                style: const TextStyle(
                    fontSize: 12,
                  ...
                  child: isDesktop
                      ? GridView.builder(
                          ...
                          itemBuilder: (context, i) =>
                              _buildBannerCard(_banners[i], i, true),
                        )
                      : ListView.builder(
                          padding:
                          ...
                          itemCount: _banners.length,
                          itemBuilder: (context, i) =>
                              _buildBannerCard(_banners[i], i, false),
                        ),
                ),
    );
  }
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    _actionIcon(Icons.edit_rounded, const Color(0xFF3B82F6),
                        () => _showBannerForm(existing: b)),
                    ...
                    const SizedBox(width: 6),
                    _actionIcon(Icons.delete_rounded, const Color(0xFFEF4444),
                        () => _deleteBanner(b)),
                  ],
                ),
              ),
