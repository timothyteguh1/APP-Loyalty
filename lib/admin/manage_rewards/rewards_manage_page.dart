...
class _RewardsManagePageState extends State<RewardsManagePage> {
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Tampilkan di halaman Best Deal user',
                                    style: TextStyle(
                                      fontSize: 11,
                                      color: isBestDeal
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: Text('${_rewards.length} hadiah',
                style: const TextStyle(
                    fontSize: 12,
  ...
  Widget _buildRewardCard(
      Map<String, dynamic> r, int index, bool isDesktop) {
                ...
                children: [
                  ...
                  Row(children: [
                    _actionBtn(Icons.edit_rounded, 'Edit',
                        const Color(0xFF3B82F6),
                        () => _showRewardForm(existing: r)),
                    const SizedBox(width: 6),
                    _actionBtn(
                      isBestDeal
                          ? Icons.star_rounded
                          : Icons.star_border_rounded,
                      isBestDeal ? 'Hapus BD' : 'Best Deal',
                      const Color(0xFFF59E0B),
                      () => _toggleBestDeal(r),
                    ),
                    const SizedBox(width: 6),
