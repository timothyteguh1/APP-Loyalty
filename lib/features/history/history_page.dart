    ...
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, isDesktop, child) {
        return Scaffold(
          ...
          body: isDesktop
              // Jika Desktop: Tahan lebarnya maksimal 800px dan taruh di tengah
              ? Center(
              ...
              // Jika Mobile: Biarkan full width seperti aslinya
    ...
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, isDesktop, child) {
        return Scaffold(
          backgroundColor: const Color(0xFFF5F5F5),
          body: isDesktop
              // Jika Web/Desktop: Bungkus konten di tengah maksimal 800px
              ? Center(
                  child: ConstrainedBox(
                    constraints: const BoxConstraints(maxWidth: 800),
                    child: _buildDetailContent(context, reward, status, uniqueCode, statusColor, statusText, statusIcon),
                  ),
                )
              : _buildDetailContent(context, reward, status, uniqueCode, statusColor, statusText, statusIcon),
        );
      }
    );
  }

  // KONTEN DETAIL VOUCHER
