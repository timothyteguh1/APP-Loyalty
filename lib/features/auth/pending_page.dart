...
class _PendingPageState extends State<PendingPage> with TickerProviderStateMixin {
                    ...
                    child: AnimatedBuilder(
                      ...
                      builder: (_, child) => Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [BoxShadow(color: const Color(0xFFF59E0B).withOpacity(0.3), blurRadius: 30 + (_pulseAnim.value * 10), offset: const Offset(0, 10))],
                        ),
                        child: AnimatedBuilder(
                          animation: _rotateAnim,
                          builder: (_, __) => Transform.rotate(
                            angle: _rotateAnim.value * 6.28 * 0.1, // Gentle rotation
                            child: const Icon(Icons.hourglass_top_rounded, size: 52, color: Color(0xFFF59E0B)),
                          ),
                        ),
                      ),
                    ),
                  ...
                  FadeTransition(
                    ...
                    child: SlideTransition(
                      ...
                      child: Container(
                        ...
                        child: Column(children: [
                          const Text('Akun Anda sedang dalam proses verifikasi oleh Admin. Proses ini biasanya memakan waktu 1x24 jam.',
                            style: TextStyle(fontSize: 14, color: Color(0xFF6B7280), height: 1.6), textAlign: TextAlign.center),
                          const SizedBox(height: 28),

                          // Status steps
                          _statusStep(Icons.check_circle_rounded, 'Data pendaftaran terkirim', const Color(0xFF10B981), true, 0),
                          _connector(),
                          _statusStep(Icons.pending_rounded, 'Verifikasi admin diproses', const Color(0xFFF59E0B), true, 1),
                          _connector(),
                          ...
                          SizedBox(width: double.infinity, height: 52, child: ElevatedButton(
                            ...
                            child: _isChecking
                              ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [SizedBox(width: 20, height: 20, child: CircularProgressIndicator(color: Colors.white.withOpacity(0.9), strokeWidth: 2.5)), const SizedBox(width: 12), const Text('Mengecek...', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15))])
                              : const Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.refresh_rounded, size: 20), SizedBox(width: 8), Text('Cek Status Verifikasi', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15))]),
                          )),
      ...
      child: Row(children: [
        AnimatedBuilder(
          ...
          builder: (_, __) => Container(
            width: 42, height: 42,
            decoration: BoxDecoration(
              color: color.withOpacity(active ? (0.1 + _pulseAnim.value * 0.05) : 0.08),
        ...
        Expanded(child: Text(text, style: TextStyle(fontSize: 14, fontWeight: active ? FontWeight.w600 : FontWeight.w500, color: active ? const Color(0xFF1A1A2E) : const Color(0xFF9CA3AF)))),
      ]),
    );
  }
  ...
  Widget _connector() {
    return Padding(
      ...
      child: Container(width: 2, height: 24, decoration: BoxDecoration(color: Colors.grey[200], borderRadius: BorderRadius.circular(1))),
    );
  }
}