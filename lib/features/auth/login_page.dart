...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _identifierFocus.addListener(
      () => setState(() => _idFocused = _identifierFocus.hasFocus),
    );
    _passwordFocus.addListener(
      () => setState(() => _pwFocused = _passwordFocus.hasFocus),
    );
    _formAnim.forward();
  }
  ...
  Future<void> _handleLogin() async {
    ...
    if (identifier.isEmpty || password.isEmpty) {
      setState(() {
        _error = 'Email/No HP dan Password wajib diisi';
    ...
    try {
      await _authController.signIn(identifier: identifier, password: password);
      if (!mounted) return;
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        _buildField(
                                          ...
                                          hint: 'email@contoh.com atau 08xxx',
