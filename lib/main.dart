...
class _ApprovalCheckerState extends State<_ApprovalChecker> {
  ...
  Widget build(BuildContext context) {
    ...
    // [PERBAIKAN RUTE]
    // LANGKAH 1 — User dari Accurate / OTP (belum punya password dan profil belum komplit)
    // Jika user mendaftar sendiri via aplikasi, profilnya sudah pasti komplit, jadi otomatis lewat!
    if (!_hasPassword && !_isProfileCompleted)
      return const _SetupPasswordPage();

    // LANGKAH 2 — Belum lengkapi profil (Form untuk user Accurate)
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Buat password untuk login berikutnya.\nSetelah ini, lengkapi data toko kamu.',
                        style: TextStyle(
                          fontSize: 13,
...
class _ResetPasswordPageState extends State<_ResetPasswordPage> {
  ...
  InputDecoration _inputDeco(String hint, bool show, VoidCallback toggle) =>
      InputDecoration(
        hintText: hint,
        hintStyle: TextStyle(color: Colors.grey[400], fontSize: 14),
        prefixIcon: Icon(
